...
namespace cis237inclass1
{
    class UserInterface
    {
        ...
        //This eill print the menu to the screen, and await a valid input
        ...
        public int GetUserInput()
        {
            ...
            //Get user getUserInput from the terminal. Whatever they typeof will come
            ...
            //a 1 or a 2, so there is mo need for me to use a try / catch here.
            //I could, but it should Never hit the catch.
            return Int32.Parse(input);
        }
        //Take in a string that we would like output to the screen
        //Irealize tht this will be about the same as just using a 
        ...
        //This id just a private method to print the Menu. It will probably
